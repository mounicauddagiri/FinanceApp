...
import { AreaChart, XAxis, YAxis, Area, Tooltip, ResponsiveContainer, Line, CartesianGrid, Legend, LineChart, BarChart, Bar } from "recharts";
...
const Row1 = () => {
  ...
  return (
    ...
    <LineChart 
      data={revenueProfit}
      margin={{ 
        top: 20, right: 0, left: -10, bottom: 60
      }}>
    ...
    <DashboardBox gridArea="c">
      <BoxHeader
        ...
        />
      <ResponsiveContainer width="100%" height="100%">
        <BarChart width={500} height={300} data={revenue} margin={{top: 17, right: 15, bottom: 50, left: -5}}>
          <defs>
              <linearGradient id="colorRevenue" x1="0" y1="0" x2="0" y2="1">
              <stop 
                offset = "5%"
